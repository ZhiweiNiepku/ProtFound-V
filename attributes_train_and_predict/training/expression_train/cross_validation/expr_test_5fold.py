...
if __name__ == '__main__':
    ...
    if 1:
        # load train data
        train_feats=np.load('<path to embedding data>/train_data.npy')
        ...
        # load test data
        test_feats=np.load('<path to embedding data>/test_data.npy')
        test_reg_label=np.load('<path to label>/test_expr_label.npy')
