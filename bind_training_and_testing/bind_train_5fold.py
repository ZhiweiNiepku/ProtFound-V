...
if __name__ == '__main__':
    ...
    feats=np.load('<path to embedding data>/4KwPtest_train_85_embedding_data.npy')
    reg_label=np.load('<path to label>/4KwPtest_train_85_embedding_label.npy').reshape(-1,1)
