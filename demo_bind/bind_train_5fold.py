...
if __name__ == '__main__':
    ...
    res_dir = "result_{}_a{}_lr{}_regk{}_k{}_f1_prop".format(BATCH_SIZE,cls_alpha,lr,REG_LOSS_K,k)
    ...
    feats=np.load('data/QuickStart/data/4KwPtest_train_85_embedding_data.npy')
    reg_label=np.load('data/QuickStart/data/4KwPtest_train_85_embedding_label.npy').reshape(-1,1)
    ...
    # get valid set with same number of positive and negative samples
