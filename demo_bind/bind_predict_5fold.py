...
if __name__ == '__main__':
    ...
    if 1:
        # load train data
        train_feats=np.load('data/QuickStart/data/4KwPtest_train_85_embedding_data.npy')
        ...
        # load test data
        test_feats=np.load('data/QuickStart/data/pnas_test_85_embedding_data.npy')
        test_reg_label=np.load('data/QuickStart/data/pnas_test_85_embedding_label.npy')
