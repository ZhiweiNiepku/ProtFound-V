...
if 0:
    bind_reg=np.load('{}/bind_result/predict_reg_{}.npy'.format(name,name))
    expr_reg=np.load('{}/expr_result/predict_reg_{}.npy'.format(name,name))
    escape_reg=np.load('{}/escape_result/predict_reg_{}.npy'.format(name,name))
    bind_cls=np.load('{}/bind_result/predict_cls_{}.npy'.format(name,name))
    expr_cls=np.load('{}/expr_result/predict_cls_{}.npy'.format(name,name))
    escape_cls=np.load('{}/escape_result/predict_cls_{}.npy'.format(name,name))
    ...
    if 1:
        ...
        plt.xlim(-5,max_-331)
        plt.savefig('{}/plot_{}_{}_{}.png'.format(name,bind_cls,expr_cls,escape_cls))
...
if 1:
    ...
    if 1:
        ...
        data.to_csv('./{}_data.csv'.format(name),index=False)